...
public:
    ...
    L2MuonPtCut = 0; // Pt cut for L2Muon, which will be matched to passing probe, use 27 GeV, because they will be filtered by IsoMu27
	}
  ...
  double L2MuonPtCut;
	...
	Bool_t IsProbe( KPMuon probeCand, NtupleHandle *ntuple )
	{
        ...
        probeCand.IsL1MatchedQuality(ntuple, L1MuonPtCut, 8)  )
			flag = kTRUE;
	...
	{
		Bool_t flag = kFALSE;
		if( probe.IsL2Matched( ntuple, L2MuonPtCut ) ) //Pt cut
			flag = kTRUE;
  ...
  double L2MuonPtCut;
	...
	void Produce()
	{
		...
		for(Int_t i_ev=0; i_ev<nEvent; i_ev++)
		{
          ...
          myTnpPair_ij->L2MuonPtCut = L2MuonPtCut;
          //==== validation
          ...
          myTnpPair_ji->L2MuonPtCut = L2MuonPtCut;
          //==== validation
